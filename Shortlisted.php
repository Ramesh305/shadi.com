...
<div id="preferred">
<p style="background-color:#cc0000; height:30px; color:#FFFFFF"><b>Shortlisted / Saved Profiles</b></p>
<p align="right"><a href="shubhvivahhomepage.php">Home</a> >> <i>Shortlisted Profiles</i></p>
...
<a href="read_more.php?id=<?php echo $user_id; ?>">Read More...</a>
</label>
</div>
<?php } ?>
