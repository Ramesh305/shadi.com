...
<body>
	...
	<div class="row" id = "message_well">
		<input type="button" name="new_message" id="new_message" value="Reply pending from member" /></button>
        
		<input type="button" name="replied_message" id="replied_message" value="Read By Member" /></button>
...
<div class="row" id="message_box">
    ...
    <label id="n_message" class="p_message"><p id="p_color"> Reply pending from member </p><br /><?php echo $message;  ?>
    </label>
	<label id="a_message" class="p_message"><p id="p_color"> Read By Member </p><br />
    <?php echo $to_id;
echo $message;   ?></label>
