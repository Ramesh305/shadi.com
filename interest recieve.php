...
<form>
	<div class="row" id="intrestes_title">New Presonalized Message 
    </div>
       
	<div class="row" id = "message_well">
		<input type="button" name="new_intrests" id="new_intrests" value="New intrests" /></button>
        
		<input type="button" name="accept_intrests" id="accept_intrests" value="Accept Intrests" /></button>
...
<div class="row" id="message_box">
    ...
    <label id="n_intrests" class="p_intrests"><p id="p_color"> New Intrests </p><br /><?php echo $my_intrestes;  ?>
    </label>
	<label id="a_intrests" class="p_intrests"><p id="p_color"> Accept intrests </p><br />
    <?php echo $to_id;
...
<div id="send_message"><label><p id="p_color">Send Messages</p></label><br />
		...
		<input type="button" name="decline" id="decline" value="Decline_intrests" />
