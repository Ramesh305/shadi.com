...
<?php
$marital = $_SESSION['search_marital'];
$caste = $_SESSION['search_caste'];
$tongue = $_SESSION['search_tongue'];
$religion = $_SESSION['search_religion'];
 $age = $_SESSION['search_age'];
$age2 =	$_SESSION['search_age2'] ;
$height = $_SESSION['search_height'];

	$height2 = $_SESSION['search_height2'];
?>
<div class = "row">
<div class = "col-md-6">
...
if($gen=='Male')
{
$sqlmatch = "SELECT * FROM registration WHERE religion LIKE '%" . $religion . "%'
                  OR caste LIKE '%" . $caste . "%'
                   OR mothertongue LIKE '%" . $tongue . "%' AND gender ='Female'";
}
else
{
$sqlmatch = "SELECT * FROM registration WHERE religion LIKE '%" . $religion . "%'
                  OR caste LIKE '%" . $caste . "%'
                   OR mothertongue LIKE '%" . $tongue . "%' AND gender ='Male'";
}
